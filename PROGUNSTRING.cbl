      ...
      * Date: 15/04/26
      * Purpose: DEMOSTRAÇÃO DO COMANDO UNSTRING
      * Tectonics: cobc
      ******************************************************************
      ...
      **********************FORMA 1 ************************************
            ...
            UNSTRING
                WS-NOME-COMPLETO
                DELIMITED BY SPACE                                      *Podemos tambem usar para espaço("")funciona igual como se usassemos a palavra SPACE*
                INTO WS-PRIM-NOME
                     WS-NOME-MEIO
                     WS-ULTI-NOME
            END-UNSTRING.
      ...
      **********************FORMA 3 ************************************
            ...
            UNSTRING
                WS-NOME-COMPLETO
                DELIMITED BY '*' OR ';'                                      *Podemos tambem usar para espaço("")funciona igual como se usassemos a palavra SPACE*
                INTO WS-PRIM-NOME
                     WS-NOME-MEIO
                     WS-ULTI-NOME
                WITH POINTER WS-PONTEIRO
      ...
      **********************FORMA 5 ************************************
            ...
            MOVE '*MARIO;;;;;;CEZAR;CASTRO;'   TO WS-NOME-COMPLETO      * O(;) oculta os carracteres*
            MOVE 2                             TO WS-PONTEIRO

            UNSTRING
                WS-NOME-COMPLETO
                DELIMITED BY '*' OR ALL ';'                             *O (ALL) mostra os itens que estavam ocultos pelo(;)*
                INTO WS-PRIM-NOME COUNT IN WS-TM-1
                     WS-NOME-MEIO COUNT IN WS-TM-2
                     WS-ULTI-NOME COUNT IN WS-TM-3
                WITH POINTER WS-PONTEIRO
